...
C = "Python_Scripts\Piano\Piano Notes\C.wav"  # <<< file path
C_note = pygame.mixer.Sound(C)

D = "Python_Scripts\Piano\Piano Notes\D.wav"
D_note = pygame.mixer.Sound(D)

E = "Python_Scripts\Piano\Piano Notes\E.wav"  
E_note = pygame.mixer.Sound(E)

F = "Python_Scripts\Piano\Piano Notes\F.wav"  
F_note = pygame.mixer.Sound(F)

G = "Python_Scripts\Piano\Piano Notes\G.mp3"  
G_note = pygame.mixer.Sound(G)

A5 = "Python_Scripts\Piano\Piano Notes\A5.wav"  
A5_note = pygame.mixer.Sound(A5)

A = "Python_Scripts\Piano\Piano Notes\A.wav"  
...
background_image = pygame.image.load("Python_Scripts\Piano\keys.jpg")  # Replace with the actual file path in your PC
